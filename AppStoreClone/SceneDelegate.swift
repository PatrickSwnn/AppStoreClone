    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        /*
         let tabBarController = UITabBarController()
                ...
                let tableLocationViewController = TableLocationView()
                
                mapViewController.tabBarItem = UITabBarItem(tabBarSystemItem: .topRated, tag: 0)
                tableLocationViewController.tabBarItem = UITabBarItem(tabBarSystemItem: .history, tag: 1)
                
                tabBarController.selectedIndex = 0
                tabBarController.viewControllers = [mapViewController, tableLocationViewController]
